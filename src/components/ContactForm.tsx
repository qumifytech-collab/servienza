...
const ContactForm = () => {
  ...
  return (
    <section id="contact" className="py-24 px-8 bg-[#fff]">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-4 items-stretch">
        ...
        {submitted ? (
          ...
          <form
            ...
            className="bg-[#F4F0EA] rounded-[2rem] p-6 flex flex-col gap-6"
          >
            ...
            <button
              type="submit"
              disabled={submitting}
              className="group w-full flex items-center justify-center gap-2 bg-[#141413] text-white rounded-xl py-4 text-base cursor-pointer disabled:opacity-60"
            >
