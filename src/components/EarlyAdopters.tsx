  ...
  return (
    <section className="max-w-6xl mx-auto flex flex-col md:flex-row justify-center md:items-stretch overflow-hidden">
      ...
      <div className="flex-shrink-0 flex items-center px-8 py-4">
        <p className="text-md leading-snug text-[#8b90a5] w-28">
      ...
      <div className="relative flex-1 overflow-hidden flex items-center">
        {/* Left fade */}
        <div className="pointer-events-none absolute left-0 top-0 bottom-0 w-16 z-10 bg-gradient-to-r from-[#FFFDFB] to-transparent" />
        {/* Right fade */}
        <div className="pointer-events-none absolute right-0 top-0 bottom-0 w-16 z-10 bg-gradient-to-l from-[#FFFDFB] to-transparent" />
